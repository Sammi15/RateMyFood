...
<body>
        ...
        <div class="container">
            ...
            <nav class="collapse navbar-collapse" id="rock-navigation">
                <ul class="nav navbar-nav navbar-right main-navigation text-uppercase">
                    ...
                    <li><a href="#" class="smoothScroll" style="color: #eb5424;">Cooks</a></li>
    ...
    <div class="container">
        ...
        <h3 align="center" style="font-family:cambria;"><u>Cook Details</u></h3>
        <br />
        <div style="float:right;">
            <button onclick="document.getElementById('id01').style.display='block'" class="button-33" style="background-color: lightgreen;border-radius:5px;">Add Cook</button>
    ...
    <div id="id01" class="w3-modal">
        <div class="w3-modal-content" style="width:25%;border-radius:10px; ">
            <div class="w3-container" style="padding: 20px;margin-top:100px">
                ...
                <form action="fetch_cook.php" method="post" name="form1">
