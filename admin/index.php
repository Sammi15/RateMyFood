          ...
          <div class="col-md-6  ">
            <div class="box" style="background-color:white;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px;">
              ...
              <div class="detail-box">
                ...
                <h6>
                  <span style="color:black;font-family:cursive">Breakfast</span>
                </h6>
          ...
          <div class="col-md-6  ">
            <div class="box " style="background-color:white;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px;">
              ...
              <div class="detail-box">
                ...
                <h6>
                  <span style="color:black;font-family:cursive">Lunch</span>
                </h6>
          ...
          <div class="col-md-6  ">
            <div class="box " style="background-color:white;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px;">
              ...
              <div class="detail-box">
                ...
                <h6>
                  <span style="color:black;font-family:cursive">Dinner</span>
                </h6>
          ...
          <div class="col-md-6  ">
            <div class="box " style="background-color:white;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px;">
              ...
              <div class="detail-box">
                ...
                <h6>
                  <span style="color:black;font-family:cursive">Snacks</span>
                </h6>
                <a href="menu_list.php?menu=Snacks" style="text-decoration:none;">
                  Add Now
                  <g>
                    <g>
                      <path d="M345.6,338.862c-29.184,0-53.248,23.552-53.248,53.248c0,29.184,23.552,53.248,53.248,53.248
