...
<body>
  ...
  <div id="login-button">
    ...
    <center>
      <h4 style="color:white;margin-top:-8px">Click here To</h4>
    </center>
    <center>
      <h4 style="color:white;margin-top:-20px">Get Started</h4>
    </center>
  </div>
  ...
  <footer>
    ...
    <div class="footer-bottom">
      ...
      <center>
        <p style="margin-top:-25px;">&copy 2023 - Designed & Developed by BVoc[S&AD] , All Rights Reserved </p>
      </center>
    </div>
