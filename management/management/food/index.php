...
<body>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="index.php?a=1" class="dropdown-item" style="font-size:11px;">Food</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="index.php?a=2" class="dropdown-item" style="font-size:11px;">Food</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="index.php?a=3" class="dropdown-item" style="font-size:11px;">Food</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="index.php?a=4" class="dropdown-item" style="font-size:11px;">Food</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="index.php?a=5" class="dropdown-item" style="font-size:11px;">Food</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
    ...
    <div class="container">
        ...
        <h3 align="center" style="font-family:cursive; margin-top:10%"><u>Upload Food Menu</u></h3>
    ...
    <div id="id01" class="w3-modal">
        <div class="w3-modal-content" style="width:20%;height:60%;">
            <div class="w3-container" style="margin-top:15%; ">
                ...
                <br /><br />
                <center>
                    <h3 style="color:#41cc74;font-family:cursive;"> Add Food</h3>
                </center>
