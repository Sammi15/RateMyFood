                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=1" class="dropdown-item" style="font-size:11px;">Rating Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=2" class="dropdown-item" style="font-size:11px;">Rating Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=3" class="dropdown-item" style="font-size:11px;">Rating Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=4" class="dropdown-item" style="font-size:11px;">Rating Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=5" class="dropdown-item" style="font-size:11px;">Rating Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                ...
                <center>
                    <div class="div_style" style="margin-top:6%;">
                        ...
                        <form action="" method="POST">
                            ...
                            <h3 class="style_text"><u>Generate Report:</u></h3>
                    ...
                    <center>
                        ...
                        $sql = "SELECT * FROM rating r INNER JOIN food f ON r.food_id = f.food_id INNER JOIN users u ON r.user_id = u.user_id INNER JOIN cook c ON r.cook_id = c.cook_id INNER JOIN hostel h ON c.hostel_id = h.hostel_id WHERE timestamp BETWEEN '$startdate' AND '$enddate' and r.hostel_id = $hstl ORDER BY f.category";
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color:white;color:grey;font-family:cursive;">ROLE
                                        </th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">CATEGORY</th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">FOOD NAME
                                        </th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">COOK NAME
                                        </th>
                            ...
                            <td style='margin-right:20px;font-family:cursive;'>" . $row['hostel_name'] . "</td>
                              <td style='margin-right:20px;font-family:cursive;'>" . $row['name'] . "</td>
                               <td style='margin-right:20px;font-family:cursive;'>" . $row['role'] . "</td>
                                <td style='margin-right:20px;font-family:cursive;'>" . $row['category'] . "</td>
                                  <td style='margin-right:20px;font-family:cursive;'>" . $row['food_item'] . "</td>
                                    <td style='margin-right:20px;font-family:cursive;'>" . $row['cook_name'] . "</td>
                                      <td style='margin-right:20px;font-family:cursive;'>" . $row['rating'] . "</td>
