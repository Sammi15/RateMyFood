                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=1" class="dropdown-item" style="font-size:11px;">Comments Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=2" class="dropdown-item" style="font-size:11px;">Comments Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=3" class="dropdown-item" style="font-size:11px;">Comments Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=4" class="dropdown-item" style="font-size:11px;">Comments Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li style="list-style:none;margin-left:-40px">
                                    <a href="Report.php?a=5" class="dropdown-item" style="font-size:11px;">Comments Report</a>
                                </li>
                                <li style="list-style:none;margin-left:-40px">
                ...
                <center>
                    ...
                    <center>
                        ...
                        <div class="tables">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color:white;color:grey;font-family:cursive;">HOSTEL</th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">ROLL NUMBER</th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">CATEGORY</th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">FOOD NAME</th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">COOK NAME</th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">RATING</th>
                                        <th style="background-color:white;color:grey;font-family:cursive;">COMMENTS</th>
                                        <th style="background-color:white;color:grey;font-family:cursive;width:10px"></th>
                                    </tr>
                                </thead>
                            ...
                            <td style='margin-left:20px;font-family:cursive;'>" . $count . "</td>
                            <td style='margin-left:20px;font-family:cursive;'>" . $row['hostel_name'] . "</td>
                              <td style='margin-left:20px;font-family:cursive;'>" . $row['name'] . "</td>
                                <td style='margin-left:20px;font-family:cursive;'>" . $row['category'] . "</td>
                                  <td style='margin-left:20px;font-family:cursive;'>" . $row['food_item'] . "</td>
                                    <td style='margin-left:20px;font-family:cursive;'>" . $row['cook_name'] . "</td>
                                      <td style='margin-left:20px;font-family:cursive;'>" . $row['rating'] . "</td>
                                        <td style='margin-left:20px;font-family:cursive;'>" . $row['description'] . "</td>
                                          <td style='margin-right:20px;font-family:cursive;'></td>
